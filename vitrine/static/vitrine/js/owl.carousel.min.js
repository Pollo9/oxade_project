...
function(a, b, c, d) {
    ...
    e.Defaults = {
        ...
        }, this)), c.dotsData || (this._templates = [a("<button>").attr('aria-label', 'dot').addClass(c.dotClass).append(a("<span>")).prop("outerHTML")]), this._controls.$absolute = (c.dotsContainer ? a(c.dotsContainer) : a("<div>").addClass(c.dotsClass).appendTo(this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "button", a.proxy(function(b) {
